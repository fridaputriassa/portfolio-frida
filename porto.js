document.addEventListener('DOMContentLoaded', () => {
    ...
    const floatingThemeIcon = floatingThemeToggle.querySelector('i');
    ...
    if (savedTheme === 'dark') {
        ...
        floatingThemeIcon.classList.remove('fa-moon');
        floatingThemeIcon.classList.add('fa-sun');
    }
    ...
    function toggleTheme() {
        ...
        if (newTheme === 'dark') {
            ...
            floatingThemeIcon.classList.remove('fa-sun');
            floatingThemeIcon.classList.add('fa-moon');
        }
    }
